...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            numericInput("H1_weight", "Hypothesis 1 Weight", 0.575, min = 0.0, max = 0.99),
            numericInput("H2_weight", "Hypothesis 2 Weight", 0.175, min = 0.0, max = 0.99),
            numericInput("H3_weight", "Hypothesis 3 Weight", 0.175, min = 0.0, max = 0.99),
            numericInput("H4_weight", "Hypothesis 4 Weight", 0.075, min = 0.0, max = 0.99),
            ...
            HTML("<strong>Note:</strong> Actions would only occur in W or AN years. Old and Middle River + Suisun Marsh Salinity Control Gate actions are present across all alternatives."),
        ),
